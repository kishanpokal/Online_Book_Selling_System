                            ...
                            <table>
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="edit_book_code.php?id=<?php echo $data['bookid'];?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline">EDIT</button></a></td>
                                        <td> <a href="delete_books.php?id=<?php echo $data['bookid']; ?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline" >DELETE</button></a></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
