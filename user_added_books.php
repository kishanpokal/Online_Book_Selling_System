...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="user_added_books.php?aid=<?php echo $aid ?>" class="active">
                        ...
                        <div class="box-body overflow-scroll">
                            <table>
                                ...
                                <?php
                                    ...
                                    $records = mysqli_query($conn,"SELECT * FROM `user_selled_books`"); // fetch data from database
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="user_added_books_delete_backend.php?id=<?php echo $data['book_id']; ?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline" >DELETE</button></a></td>
                                        <td> <a href="user_added_books_allow_backend.php?id=<?php echo $data['book_id']; ?>&aid=<?php echo $aid ?>" class="nav-link icon"><button class="btn btn-outline" >ALLOW</button></a></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
